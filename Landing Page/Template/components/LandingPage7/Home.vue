<template>
    <ParallaxStyle1 ids="iq-home" class-names="iq-banner-03 overview-block-pt iq-bg-over iq-over-blue-90 iq-parallax" :bg-image="require('../../assets/images/bg/01.jpg')">
         <div class="container">
            <div class="banner-text">
                  <div class="row">
                    ...
                    <div class="iq-banner-video">
                        <div class="waves-box">
                            <a href="./assets/video/01.mp4" class="iq-video popup-youtube"><i class="ion-ios-play-outline"></i></a>
                            <div class="iq-waves">
                        ...
                        <img class="banner-img" :src="require('../../assets/images/banner/05.png')" alt="Home">
                    </div>
                    </div>
                </div>
            </div>
