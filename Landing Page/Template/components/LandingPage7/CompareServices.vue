<template>
    <div>
        <section id="compare-services" class="iq-compare-services overview-block-ptb iq-over iq-over-blue-90 iq-parallax" data-jarallax='{"speed": 0.6}' :bg-image="bgImage" >
            <div class="container">
                <div class="row">
                <div class="col-sm-12">
                    <div class="heading-title white">
                    <h3 class="title iq-tw-7">Compare Services</h3>
                    <p class="iq-font-white">Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>
                    </div>
                </div>
                </div>
                <div class="row">
...
export default {
    name:'CompareServices',
      data () {
        return {
            bgImage: require('../../assets/images/bg/05.jpg')
        }
    }
}
</script>