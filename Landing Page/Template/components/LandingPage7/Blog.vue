                ...
                <div class="col-sm-12">
                    ...
                    <div class="item">
                        ...
                        <div slot="cardMedia">
                            ...
                            <video style="width:100%;height:100%;" id="player1" :poster="require('../../assets/video/01.jpg')" controls preload="none">
                        ...
                        <div slot="cardBody">
                            <p>Quae laboriosam sunt consectetur, assumenda provident lorem ipsum dolor sit amet.</p>
                        </div>
                        <div slot="cardFooter">
                    ...
                    <div class="item">
                        <CardStyle1>
                        <div slot="cardMedia">
                            <img class="img-fluid center-block" :src="require('../../assets/images/blog/01.jpg')" alt="#">
                        </div>
                        <div slot="cardTitle">
                            <a href="javascript:void(0)">
                    ...
                    <div class="item">
                        <CardStyle1>
                        <div slot="cardMedia">
                            <img class="img-fluid center-block" :src="require('../../assets/images/blog/03.jpg')" alt="#">
                    ...
                    <div class="item">
                        <CardStyle1>
                        <div slot="cardMedia">
                            <img class="img-fluid center-block" :src="require('../../assets/images/blog/02.jpg')" alt="#">
                        </div>
                        <div slot="cardTitle">
                            <a href="javascript:void(0)">
                            <h5 class="iq-tw-7 iq-mb-10">Blogpost With Image</h5>
